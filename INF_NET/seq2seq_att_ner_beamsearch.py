				...
				f = open('pred_ner_inf_' + params.outfile, 'w')
                                ...
                                for ii, devl in enumerate(devlength):
                                        for jj in range(devl):
                                                eva_string = params.devrawx[ii][jj] + ' '+ params.devpos[ii][jj] + ' '+ params.taggerlist[devy1[jj, ii]] +' ' +  params.taggerlist[devpred[ii][jj]]
					...
					f = open('pred_ner_inf_' + params.outfile, 'w')
                                	...
                                	for ii, testl in enumerate(testlength):
                                        	for jj in range(testl):
                                                	eva_string = params.testrawx[ii][jj] + ' '+ params.testpos[ii][jj] + ' '+ params.taggerlist[testy1[jj, ii]] +' ' +  params.taggerlist[testpred[ii][jj]]
