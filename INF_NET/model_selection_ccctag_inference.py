        	...
        	try:
				...
				start_time2 = time.time()
                                ...
                                for _, dev_index in dev_kf:
                                        ...
                                        _, _,  devpred0, devnum0, _   = self.eval_fn(devx0, devy0, devx0mask, devx0mask1, devmaxlen)
                                        devpred += devpred0
                                        devnum += devnum0
				...
				if bestdev < devacc:
					...
					test_kf = get_minibatches_idx(len(testX), 100)
                                	...
                                	for _, test_index in test_kf:
                                        	...
                                        	_, _, testpred0, testnum0, _   = self.eval_fn(testx0, testy0, testx0mask, testx0mask1,testmaxlen)
                                        	testpred += testpred0
                                        	testnum += testnum0
