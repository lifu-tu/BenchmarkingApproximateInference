...
def Base(eta, l3, emb, num_filters, inf, hidden_inf):
	params.outfile = 'MoreLayer_CRF_Inf_NER_'
	...
	params.outfile = params.outfile+".num_filters"+'_'+str(num_filters)+'_dropout_'+ str(params.dropout) + '_LearningRate_'+str(params.eta)+ '_'  + str(l3) +'_emb_'+ str(emb)+ '_inf_'+ str(params.inf)+ '_hidden_'+ str(params.hidden_inf)
	...
	if (inf ==0) or (inf==1):
		from model_selection_NER_inference_morelayers import CRF_model
