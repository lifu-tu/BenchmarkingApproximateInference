	...
	def train(self, train, dev, test, params):	
		...
		tagger_keys = params.tagger.keys()
        	...
        	try:
				...
				devloss, devloss0, devpred, devnum, devpred   = self.eval_fn(devx0, devx0_char, devy0, devx0mask, devx0mask1, devmaxlen, devx1_in2, 0.)
				...
				if bestdev < dev_f10:
					...
					testloss, _, testpred, testnum, testpred = self.eval_fn(testx0, testx0_char, testy0, testx0mask, testx0mask1, testmaxlen, testx1_in2, 0.)
